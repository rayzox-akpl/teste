...
local function startSpamLoop()
    ...
    -- On se replace AVANT de couper le float et de rendre la main
    -- a l'orbit, sinon le perso tombe des 2000 studs.
    ...
    if backTarget and backTarget.Parent then
        -- Retour direct sur la position d'orbite courante
    ...
    -- Le float n'est retire qu'une fois en place
    stopFloat()
    stabilize()

    -- L'orbit ne reprend qu'a la toute fin
    securityMode = false
